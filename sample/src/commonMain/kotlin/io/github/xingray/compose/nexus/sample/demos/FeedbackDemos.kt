...
import io.github.xingray.compose.nexus.controls.AlertEffect
import io.github.xingray.compose.nexus.controls.MessageBoxRequest
import io.github.xingray.compose.nexus.controls.MessagePlacement
import io.github.xingray.compose.nexus.controls.NexusAlert
import io.github.xingray.compose.nexus.controls.NexusButton
import io.github.xingray.compose.nexus.controls.NexusLoading
import io.github.xingray.compose.nexus.controls.NexusLoadingServiceHost
import io.github.xingray.compose.nexus.controls.NexusMessageBoxHost
import io.github.xingray.compose.nexus.controls.NexusMessageHost
import io.github.xingray.compose.nexus.controls.NexusNotificationHost
import io.github.xingray.compose.nexus.controls.NexusPopconfirm
import io.github.xingray.compose.nexus.controls.NexusPopover
import io.github.xingray.compose.nexus.controls.NexusTag
import io.github.xingray.compose.nexus.controls.NexusText
import io.github.xingray.compose.nexus.controls.NexusTooltip
import io.github.xingray.compose.nexus.controls.NexusTour
import io.github.xingray.compose.nexus.controls.NexusTourTarget
import io.github.xingray.compose.nexus.controls.NotificationPosition
import io.github.xingray.compose.nexus.controls.PopoverPlacement
import io.github.xingray.compose.nexus.controls.PopoverTrigger
import io.github.xingray.compose.nexus.controls.TooltipPlacement
import io.github.xingray.compose.nexus.controls.TooltipTheme
import io.github.xingray.compose.nexus.controls.TooltipTrigger
import io.github.xingray.compose.nexus.controls.TourGap
import io.github.xingray.compose.nexus.controls.TourPlacement
import io.github.xingray.compose.nexus.controls.TourStep
import io.github.xingray.compose.nexus.controls.TourType
import io.github.xingray.compose.nexus.controls.rememberLoadingServiceState
import io.github.xingray.compose.nexus.controls.rememberMessageBoxState
import io.github.xingray.compose.nexus.controls.rememberMessageState
import io.github.xingray.compose.nexus.controls.rememberNotificationState
import io.github.xingray.compose.nexus.controls.rememberPopoverState
import io.github.xingray.compose.nexus.controls.rememberTooltipState
import io.github.xingray.compose.nexus.controls.rememberTourState
    ...
    DemoPage(title = "Message", description = "Used to show feedback after an activity.") {
        ...
        DemoSection("Types") {
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(
                    onClick = { messageState.primary("Primary message") },
                    type = NexusType.Primary
                ) { NexusText(text = "Primary") }
                NexusButton(
                    onClick = { messageState.success("Success!") },
                    type = NexusType.Success
                ) { NexusText(text = "Success") }
                NexusButton(
                    onClick = { messageState.warning("Warning!") },
                    type = NexusType.Warning
                ) { NexusText(text = "Warning") }
                NexusButton(
                    onClick = { messageState.error("Error!") },
                    type = NexusType.Danger
                ) { NexusText(text = "Error") }
                NexusButton(
                    onClick = { messageState.info("Info!") },
                    type = NexusType.Info
                ) { NexusText(text = "Info") }
            }
        }
    ...
    DemoPage(title = "Notification", description = "Displays a global notification message at a corner of the page.") {
        ...
        DemoSection("With types") {
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(
                    text = "Primary",
                    onClick = { state.primary("Primary", "Primary notification") },
                    type = NexusType.Primary
                )
                NexusButton(
                    text = "Success",
                    onClick = { state.success("Success", "Operation succeeded") },
                    type = NexusType.Success
                )
                NexusButton(
                    text = "Warning",
                    onClick = { state.warning("Warning", "Please double check") },
                    type = NexusType.Warning
                )
                NexusButton(
                    text = "Info",
                    onClick = { state.info("Info", "Useful information") },
                    type = NexusType.Info
                )
                NexusButton(
                    text = "Error",
                    onClick = { state.error("Error", "Something went wrong") },
                    type = NexusType.Danger
                )
            }
        }
