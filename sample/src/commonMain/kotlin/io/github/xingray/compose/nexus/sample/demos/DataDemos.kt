...
import io.github.xingray.compose.nexus.controls.AvatarFit
import io.github.xingray.compose.nexus.controls.AvatarGroupItem
import io.github.xingray.compose.nexus.controls.AvatarShape
import io.github.xingray.compose.nexus.controls.CalendarControllerType
import io.github.xingray.compose.nexus.controls.CalendarDateType
import io.github.xingray.compose.nexus.controls.CalendarFormatterType
import io.github.xingray.compose.nexus.controls.DescriptionsAlign
import io.github.xingray.compose.nexus.controls.DescriptionsDirection
import io.github.xingray.compose.nexus.controls.NexusAvatar
import io.github.xingray.compose.nexus.controls.NexusAvatarGroup
import io.github.xingray.compose.nexus.controls.NexusBadge
import io.github.xingray.compose.nexus.controls.NexusButton
import io.github.xingray.compose.nexus.controls.NexusCalendar
import io.github.xingray.compose.nexus.controls.NexusCountdown
import io.github.xingray.compose.nexus.controls.NexusDate
import io.github.xingray.compose.nexus.controls.NexusDescriptions
import io.github.xingray.compose.nexus.controls.NexusEmpty
import io.github.xingray.compose.nexus.controls.NexusImage
import io.github.xingray.compose.nexus.controls.NexusImageFit
import io.github.xingray.compose.nexus.controls.NexusImageLoading
import io.github.xingray.compose.nexus.controls.NexusInfiniteScroll
...
import io.github.xingray.compose.nexus.controls.NexusProgress
import io.github.xingray.compose.nexus.controls.NexusResult
import io.github.xingray.compose.nexus.controls.NexusResultIcon
import io.github.xingray.compose.nexus.controls.NexusSegmented
import io.github.xingray.compose.nexus.controls.NexusSegmentedOption
import io.github.xingray.compose.nexus.controls.NexusSkeleton
import io.github.xingray.compose.nexus.controls.NexusSkeletonItem
import io.github.xingray.compose.nexus.controls.NexusStatistic
...
import io.github.xingray.compose.nexus.controls.NexusTimeline
import io.github.xingray.compose.nexus.controls.NexusTree
import io.github.xingray.compose.nexus.controls.NexusVirtualizedTable
import io.github.xingray.compose.nexus.controls.NexusVirtualizedTableColumn
import io.github.xingray.compose.nexus.controls.NexusVirtualizedTree
import io.github.xingray.compose.nexus.controls.ProgressColorStop
import io.github.xingray.compose.nexus.controls.ProgressType
import io.github.xingray.compose.nexus.controls.SegmentedDirection
import io.github.xingray.compose.nexus.controls.SegmentedProps
import io.github.xingray.compose.nexus.controls.SkeletonThrottle
import io.github.xingray.compose.nexus.controls.SkeletonVariant
import io.github.xingray.compose.nexus.controls.TimelineItemSize
import io.github.xingray.compose.nexus.controls.TimelineMode
import io.github.xingray.compose.nexus.controls.TimelinePlacement
import io.github.xingray.compose.nexus.controls.TimelineScope
import io.github.xingray.compose.nexus.controls.TreeNode
import io.github.xingray.compose.nexus.controls.rememberCalendarState
import io.github.xingray.compose.nexus.controls.rememberInfiniteScrollState
import io.github.xingray.compose.nexus.controls.rememberNexusImageState
import io.github.xingray.compose.nexus.controls.rememberPaginationState
import io.github.xingray.compose.nexus.controls.rememberTableState
...
fun TableDemo() {
    ...
    val columns = listOf(
        NexusTableColumn<User>("Name", tooltipText = { it.name }) {
            NexusText(
                text = it.name
            )
        },
        NexusTableColumn<User>(
            "Age",
            width = 80.dp,
            alignment = Alignment.Center
        ) { NexusText(text = it.age.toString()) },
...
fun PaginationDemo() {
    DemoPage(title = "Pagination", description = "Divide data into pages when there's too much to show.") {
        ...
        DemoSection("Small Pagination") {
            ...
            NexusPagination(state = state, size = ComponentSize.Small)
        }
        ...
        DemoSection("Circular progress bar") {
            Row(horizontalArrangement = Arrangement.spacedBy(24.dp)) {
                ...
                NexusProgress(
                    ...
                    status = NexusType.Success
                )
                NexusProgress(
                    percentage = 50f,
                    type = ProgressType.Circle,
                    status = NexusType.Danger
                )
            }
        }
...
fun BadgeDemo() {
    DemoPage(title = "Badge", description = "A number or status mark on buttons and icons.") {
        ...
        DemoSection("Max Value") {
            Row(horizontalArrangement = Arrangement.spacedBy(18.dp), verticalAlignment = Alignment.CenterVertically) {
                NexusBadge(value = 9, max = 99) {
                    NexusTag(
                        text = "9",
                        size = ComponentSize.Small
                    )
                }
                NexusBadge(value = 120, max = 99) {
                    NexusTag(
                        text = "120",
                        size = ComponentSize.Small
                    )
        ...
        DemoSection("Customizations") {
            Row(horizontalArrangement = Arrangement.spacedBy(18.dp), verticalAlignment = Alignment.CenterVertically) {
                ...
                NexusBadge(
                    value = 7,
                    color = NexusTheme.colorScheme.success.base,
                    contentSlot = { v ->
                        NexusText(
                            text = "No.$v",
                ...
                content = {
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .background(
                                NexusTheme.colorScheme.fill.light,
                    ...
                    image = {
                        Box(
                            modifier = Modifier
                                ...
                                .height(100.dp)
                                .background(
                                    NexusTheme.colorScheme.primary.light8,
                                    NexusTheme.shapes.base
                                ),
        ...
        DemoSection("Load failed") {
            NexusImage(
                ...
                viewerError = { activeIndex, src ->
                    NexusText(
                        text = "Viewer error at $activeIndex: $src",
