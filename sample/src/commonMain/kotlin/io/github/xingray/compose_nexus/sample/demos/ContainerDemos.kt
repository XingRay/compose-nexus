    ...
    DemoPage(title = "Dialog", description = "Informs users while preserving the current page state.") {
        DemoSection("Basic usage") {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(text = "Open Dialog", onClick = { state.open() }, type = NexusType.Primary)
                NexusButton(
            ...
            NexusDialog(
                ...
                footer = {
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        NexusButton(text = "Confirm", onClick = { state.close() }, type = NexusType.Primary)
                    }
                },
            ) {
        ...
        DemoSection("Customized content") {
            val state = rememberDialogState()
            NexusButton(text = "Open Content Dialog", onClick = { state.open() }, type = NexusType.Primary)
            NexusDialog(
                state = state,
                title = "Edit Profile",
                width = 560.dp,
                footer = {
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        NexusButton(text = "Save", onClick = { state.close() }, type = NexusType.Primary)
                    }
                },
            ) {
        ...
        DemoSection("Customized header") {
            val state = rememberDialogState()
            NexusButton(text = "Open Custom Header", onClick = { state.open() }, type = NexusType.Primary)
            NexusDialog(
                state = state,
                title = "Custom Header",
                header = {
                    Row(
                        ...
                        NexusText(text = "Header Slot Content", color = NexusTheme.colorScheme.primary.base)
                        NexusText(text = "v2.0", style = NexusTheme.typography.small, color = NexusTheme.colorScheme.text.secondary)
                    }
                },
                closeIcon = {
                    NexusText(text = "◉", color = NexusTheme.colorScheme.primary.base)
                },
                footer = {
                    NexusButton(text = "Done", onClick = { state.close() }, type = NexusType.Primary)
                },
            ) {
        ...
        DemoSection("Nested dialog") {
            ...
            NexusButton(text = "Open Outer Dialog", onClick = { outer.open() }, type = NexusType.Primary)
            NexusDialog(
                state = outer,
                title = "Outer Dialog",
                width = 560.dp,
                footer = {
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        NexusButton(text = "Open Inner", onClick = { inner.open() }, type = NexusType.Primary)
                    }
                },
            ) {
            ...
            NexusDialog(
                ...
                width = 420.dp,
                footer = {
                    NexusButton(text = "Close Inner", onClick = { inner.close() }, type = NexusType.Primary)
                },
            ) {
        ...
        DemoSection("Centered content") {
            val state = rememberDialogState()
            NexusButton(text = "Open Centered Dialog", onClick = { state.open() }, type = NexusType.Primary)
            NexusDialog(
                state = state,
        ...
        DemoSection("Align center dialog") {
            val state = rememberDialogState()
            NexusButton(text = "Open Align-Center Dialog", onClick = { state.open() }, type = NexusType.Primary)
            NexusDialog(
                state = state,
                title = "Aligned Center",
                alignCenter = true,
                footer = {
                    NexusButton(text = "Close", onClick = { state.close() }, type = NexusType.Primary)
                },
            ) {
        ...
        DemoSection("Draggable dialog") {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(text = "Open Draggable", onClick = { state.open() }, type = NexusType.Primary)
                NexusButton(
        ...
        DemoSection("Fullscreen / Modal / Events") {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(text = "Open Fullscreen", onClick = { fullscreenState.open() }, type = NexusType.Primary)
            ...
            NexusDialog(
                ...
                fullscreen = true,
                footer = {
                    NexusButton(text = "Close", onClick = { fullscreenState.close() }, type = NexusType.Primary)
                },
            ) {
            ...
            NexusDialog(
                ...
                footer = {
                    NexusButton(text = "Close", onClick = { nonModalState.close() }, type = NexusType.Primary)
                },
            ) {
            ...
            NexusDialog(
                ...
                footer = {
                    NexusButton(text = "Close", onClick = { eventsState.close() }, type = NexusType.Primary)
                },
            ) {
...
fun DrawerDemo() {
    DemoPage(title = "Drawer", description = "A panel which slides in from the edge of the screen.") {
        DemoSection("Basic usage") {
            ...
            var allowClose by remember { mutableStateOf(false) }
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(text = "Open Drawer", onClick = { state.open() }, type = NexusType.Primary)
                NexusButton(
        ...
        DemoSection("No title") {
            val state = rememberDialogState()
            NexusButton(text = "Open Headerless Drawer", onClick = { state.open() }, type = NexusType.Primary)
            NexusDrawer(
                state = state,
                withHeader = false,
                size = 360.dp,
        ...
        DemoSection("Customized content") {
            val state = rememberDialogState()
            NexusButton(text = "Open Custom Content", onClick = { state.open() }, type = NexusType.Primary)
            NexusDrawer(
                state = state,
                title = "Custom Form",
                size = 420.dp,
                footer = {
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        NexusButton(text = "Reset", onClick = { })
                        NexusButton(text = "Submit", onClick = { state.close() }, type = NexusType.Primary)
                    }
                },
            ) {
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            NexusDrawer(
                ...
                header = {
                    Row(
                        ...
                        NexusText(text = "Header Slot", color = NexusTheme.colorScheme.primary.base)
                        NexusText(text = "Beta", style = NexusTheme.typography.small, color = NexusTheme.colorScheme.text.secondary)
                    }
                },
                closeIcon = {
                    NexusText(text = "◉", color = NexusTheme.colorScheme.primary.base)
        ...
        DemoSection("Resizable drawer") {
            ...
            NexusButton(text = "Open Resizable Drawer", onClick = { state.open() }, type = NexusType.Primary)
            NexusDrawer(
                state = state,
                title = "Resizable",
                resizable = true,
        ...
        DemoSection("Nested drawer") {
            val outer = rememberDialogState()
            val inner = rememberDialogState()
            NexusButton(text = "Open Outer Drawer", onClick = { outer.open() }, type = NexusType.Primary)
            NexusDrawer(
                state = outer,
                title = "Outer Drawer",
                size = 420.dp,
        ...
        DemoSection("Modal / destroy-on-close / events") {
            ...
            val events = remember { mutableStateListOf<String>() }
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusButton(text = "Open Modal Drawer", onClick = { modalState.open() }, type = NexusType.Primary)
                NexusButton(text = "Open Non-Modal", onClick = { nonModalState.open() })
            ...
            NexusDrawer(
                ...
                destroyOnClose = true,
                footer = {
                    NexusButton(text = "Close", onClick = { modalState.close() }, type = NexusType.Primary)
                },
            ) {
                var localCounter by remember { mutableIntStateOf(0) }
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            NexusDrawer(
                ...
                onCloseAutoFocus = { events.add("close-auto-focus") },
                footer = {
                    NexusButton(text = "Close", onClick = { eventState.close() }, type = NexusType.Primary)
                },
            ) {
                NexusText(
                    text = "Events: ${events.takeLast(8).joinToString(", ")}",
