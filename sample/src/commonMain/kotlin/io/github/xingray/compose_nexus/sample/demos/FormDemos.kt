    ...
    DemoPage(title = "Input", description = "Input data using keyboard.") {
        ...
        DemoSection("Custom clear icon") {
            ...
            NexusInput(
                ...
                onValueChange = { v = it },
                clearable = true,
                clearIcon = { NexusText(text = "⊗", color = NexusTheme.colorScheme.danger.base) },
        ...
        DemoSection("Input with icon") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                NexusInput(
                    value = v2,
                    onValueChange = { v2 = it },
                    suffix = { NexusText(text = "@example.com", style = NexusTheme.typography.extraSmall) },
...
fun InputNumberDemo() {
    DemoPage(title = "InputNumber", description = "Input numerical values with a customizable range.") {
        ...
        DemoSection("Size") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusInputNumber(value = v1, onValueChange = { v1 = it }, size = ComponentSize.Large)
                NexusInputNumber(value = v2, onValueChange = { v2 = it }, size = ComponentSize.Default)
                NexusInputNumber(value = v3, onValueChange = { v3 = it }, size = ComponentSize.Small)
            }
        }
        ...
        DemoSection("Custom icon") {
            ...
            NexusInputNumber(
                value = v,
                onValueChange = { v = it },
                increaseIcon = { NexusText(text = "▲", color = NexusTheme.colorScheme.primary.base) },
                decreaseIcon = { NexusText(text = "▼", color = NexusTheme.colorScheme.primary.base) },
            )
        }
        DemoSection("Prefix and suffix") {
            ...
            NexusInputNumber(
                value = v,
                onValueChange = { v = it },
                prefix = { NexusText(text = "$", style = NexusTheme.typography.small) },
                suffix = { NexusText(text = "USD", style = NexusTheme.typography.extraSmall) },
    ...
    DemoPage(title = "Checkbox", description = "A group of options for multiple choices.") {
        ...
        DemoSection("With borders") {
            ...
            NexusCheckboxGroup(state = state) {
                NexusCheckbox(value = "Kotlin", border = true) { NexusText(text = "Kotlin") }
                NexusCheckbox(value = "Compose", border = true) { NexusText(text = "Compose") }
                NexusCheckbox(value = "Element", border = true, disabled = true) { NexusText(text = "Element") }
            }
        }
    }
}
    ...
    DemoPage(title = "Radio", description = "Single selection among multiple options.") {
        ...
        DemoSection("With borders") {
            ...
            NexusRadioGroup(state = state, size = ComponentSize.Small) {
                NexusRadio(value = "A", border = true) { NexusText(text = "Option A") }
                NexusRadio(value = "B", border = true) { NexusText(text = "Option B") }
                NexusRadio(value = "C", border = true, disabled = true) { NexusText(text = "Option C") }
            }
        }
        DemoSection("Options attribute") {
        ...
        DemoSection("Radio Button") {
            ...
            NexusRadioGroup(
                ...
                NexusRadio(value = "Chicago", disabled = true) { NexusText(text = "Chicago") }
            }
        }
    }
}
...
fun RateDemo() {
    DemoPage(title = "Rate", description = "Used for rating.") {
        ...
        DemoSection("Sizes") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusRate(value = v1, onValueChange = { v1 = it }, size = ComponentSize.Large)
                NexusRate(value = v2, onValueChange = { v2 = it }, size = ComponentSize.Default)
                NexusRate(value = v3, onValueChange = { v3 = it }, size = ComponentSize.Small)
            }
        }
    ...
    DemoPage(title = "Switch", description = "Switch is used for toggling between two opposing states.") {
        ...
        DemoSection("Display custom icons") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                NexusSwitch(
                    checked = v1,
                    onCheckedChange = { v1 = it },
                    activeIcon = { NexusText(text = "✓", style = NexusTheme.typography.extraSmall) },
                    inactiveIcon = { NexusText(text = "✕", style = NexusTheme.typography.extraSmall) },
                    inlinePrompt = true,
                    width = 50.dp,
                )
                NexusSwitch(
        ...
        DemoSection("Custom action icon") {
            ...
            NexusSwitch(
                checked = checked,
                onCheckedChange = { checked = it },
                activeActionIcon = { NexusText(text = "★", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.warning.base) },
                inactiveActionIcon = { NexusText(text = "☆", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.text.placeholder) },
                width = 52.dp,
            )
        }
        ...
        DemoSection("Custom action slot") {
            ...
            NexusSwitch(
                ...
                active = { NexusText(text = "Ready", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.white) },
                inactive = { NexusText(text = "Stop", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.white) },
                width = 62.dp,
            )
        }
    }
    ...
    DemoPage(title = "Select", description = "When there are plenty of options, use a drop-down menu to display and select desired ones.") {
        ...
        DemoSection("Clearable / Sizes") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                NexusSelect(
                    state = large,
                    options = listOf(SelectOption("1", "Large 1"), SelectOption("2", "Large 2")),
                    onSelect = {},
                    clearable = true,
                    size = ComponentSize.Large,
                )
                NexusSelect(
                    state = def,
                    options = listOf(SelectOption("1", "Default 1"), SelectOption("2", "Default 2")),
                    onSelect = {},
                    clearable = true,
                    size = ComponentSize.Default,
                )
                NexusSelect(
                    state = small,
                    options = listOf(SelectOption("1", "Small 1"), SelectOption("2", "Small 2")),
                    onSelect = {},
                    size = ComponentSize.Small,
                )
            }
...
fun DatePickerPanelDemo() {
    DemoPage(title = "DatePickerPanel", description = "Core panel component of DatePicker.") {
        DemoSection("Enter Date") {
            val state = rememberDatePickerState(initialDate = NexusDate(2026, 3, 4))
        ...
        DemoSection("Border") {
            val state1 = rememberDatePickerState(initialDate = NexusDate(2026, 3, 4))
            val state2 = rememberDatePickerState(initialDate = NexusDate(2026, 3, 4))
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                NexusDatePickerPanel(
                    state = state1,
                    border = true,
        ...
        DemoSection("Types") {
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                val dateState = rememberDatePickerState(initialDate = NexusDate(2026, 3, 4))
                val monthState = rememberDatePickerState(initialDate = NexusDate(2026, 3, 1))
                val yearState = rememberDatePickerState(initialDate = NexusDate(2026, 1, 1))
                NexusDatePickerPanel(
                    state = dateState,
                    type = NexusDatePickerPanelType.Date,
                    showWeekNumber = true,
...
fun DatePickerDemo() {
    DemoPage(title = "DatePicker", description = "Use DatePicker for date input.") {
        ...
        DemoSection("Clearable / disabled / size") {
            val clearState = rememberDatePickerState(initialDate = NexusDate(2026, 3, 4))
            val disabledState = rememberDatePickerState(initialDate = NexusDate(2026, 3, 4))
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                NexusDatePicker(
                    state = clearState,
                    clearable = true,
...
fun TimePickerDemo() {
    DemoPage(title = "TimePicker", description = "Use Time Picker for time input.") {
        DemoSection("Arbitrary time picker") {
            ...
            val state2 = rememberTimePickerState(initialTime = NexusTime(13, 30, 0))
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                NexusTimePicker(
                    state = state1,
        ...
        DemoSection("Limit the time range") {
            val state = rememberTimePickerState(initialTime = NexusTime(10, 20, 30))
            NexusTimePicker(
                state = state,
                showSeconds = true,
                disabledHours = { role ->
    ...
    DemoPage(title = "Form", description = "Form consists of Input, Radio, Select, Checkbox and so on.") {
        DemoSection("Basic form") {
            ...
            NexusForm(labelWidth = 96.dp) {
                ...
                NexusFormItem(label = "") {
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        NexusButton(text = "Create", onClick = {}, type = NexusType.Primary)
        ...
        DemoSection("Inline form") {
            ...
            NexusForm(inline = true, labelWidth = 72.dp) {
                ...
                NexusFormItem(label = "") {
                    NexusButton(text = "Query", onClick = {}, type = NexusType.Primary)
                }
            }
        }
        ...
        DemoSection("Alignment") {
            ...
            var v2 by remember { mutableStateOf("") }
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                NexusForm(labelPosition = LabelPosition.Left, labelWidth = 90.dp) {
        ...
        DemoSection("Validation") {
            ...
            if (result.isNotEmpty()) {
                Spacer(modifier = Modifier.height(8.dp))
                NexusText(text = result, style = NexusTheme.typography.small, color = NexusTheme.colorScheme.text.secondary)
            }
        }
        ...
        DemoSection("Accessibility") {
            ...
            NexusForm(labelPosition = LabelPosition.Top) {
                NexusFormItem(label = "Your Name") {
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        Column {
                            NexusText(text = "First Name", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.text.placeholder)
                            NexusInput(value = firstName, onValueChange = { firstName = it }, placeholder = "First")
                        }
                        Column {
                            NexusText(text = "Last Name", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.text.placeholder)
...
fun AutocompleteDemo() {
    DemoPage(title = "Autocomplete", description = "Get suggestions while you type.") {
            ...
            NexusAutocomplete(
                ...
                itemContent = { item ->
                    Row(
                        ...
                        NexusText(text = item)
                        NexusText(text = "Framework", style = NexusTheme.typography.small, color = NexusTheme.colorScheme.text.secondary)
                    }
                },
            )
        }
        ...
        DemoSection("Events") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
                logs.forEach { line ->
                    NexusText(text = line, style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.text.secondary)
                }
            }
        }
    }
    ...
    DemoPage(title = "ColorPickerPanel", description = "Core panel component of ColorPicker.") {
        DemoSection("Basic usage") {
            ...
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                NexusText(text = "Current: $value", style = NexusTheme.typography.small)
            }
        }
...
fun ColorPickerDemo() {
    DemoPage(title = "ColorPicker", description = "Color selector with popup panel.") {
        ...
        DemoSection("Sizes") {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                NexusColorPicker(value = v1, onValueChange = { v1 = it }, size = ComponentSize.Large)
                NexusColorPicker(value = v2, onValueChange = { v2 = it }, size = ComponentSize.Default)
                NexusColorPicker(value = v3, onValueChange = { v3 = it }, size = ComponentSize.Small)
            }
        }
    ...
    DemoPage(title = "InputTag", description = "Manage a list of tags with an input.") {
        ...
        DemoSection("Custom prefix and suffix") {
            ...
            NexusInputTag(
                state = state,
                prefix = { NexusText(text = "🏷", style = NexusTheme.typography.small) },
                suffix = { NexusText(text = "Tag editor", style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.text.placeholder) },
            )
        }
        DemoSection("Events") {
...
fun MentionDemo() {
    DemoPage(title = "Mention", description = "Used to mention someone or something in an input.") {
        ...
        DemoSection("Delete as a whole") {
            ...
            Spacer(modifier = Modifier.height(8.dp))
            NexusText(text = log, style = NexusTheme.typography.extraSmall, color = NexusTheme.colorScheme.text.secondary)
        }
    ...
    DemoPage(title = "Cascader", description = "If the options have a clear hierarchical structure, cascader can be used.") {
        ...
        DemoSection("Disabled option") {
            val options = listOf(
                ...
                CascaderOption("component", "Component", listOf(
        ...
        DemoSection("Clearable") {
            val options = listOf(
                CascaderOption("frontend", "Frontend", listOf(
                    CascaderOption("vue", "Vue"),
                    CascaderOption("react", "React"),
                )),
                CascaderOption("backend", "Backend", listOf(
        ...
        DemoSection("Display only last level") {
            val options = listOf(
                CascaderOption("continent", "Continent", listOf(
                    CascaderOption("asia", "Asia", listOf(
        ...
        DemoSection("Custom header & footer") {
            val options = listOf(
                CascaderOption("lang", "Language", listOf(
                    CascaderOption("kotlin", "Kotlin"),
                    CascaderOption("typescript", "TypeScript"),
                )),
                CascaderOption("framework", "Framework", listOf(
...
fun TreeSelectDemo() {
    ...
    DemoPage(title = "TreeSelect", description = "Tree selector combining Select and Tree behavior.") {
        ...
        DemoSection("Disabled Selection") {
            val nodes = remember {
                listOf(
                    TreeNode("a", "A", children = listOf(TreeNode("a-1", "A-1", disabled = true))),
    ...
    DemoPage(title = "Upload", description = "Upload files by clicking or drag-and-drop.") {
        ...
        DemoSection("Photo Wall / Custom Thumbnail") {
            ...
            NexusUpload(
                ...
                fileContent = { file, _ ->
                    Row(horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                        NexusText(text = file.name, style = NexusTheme.typography.extraSmall)
                        NexusTag(
